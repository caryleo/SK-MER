...
class BaseTrainer:
    ...
    def train(self):
        ...
        best_epoch = 0 if self.best_epoch_resume is None else self.best_epoch_resume
    ...
    def _resume_checkpoint(self, resume_path, cl=False):
        """
        ...
        self.best_epoch_resume = checkpoint['epoch']
        ...
        ###############
        # 测试用
        # dict_test = checkpoint['state_dict']
        # names = list(dict_test)
